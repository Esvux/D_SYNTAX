...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
    final public void NOTERMS() throws ParseException {
        ArrayList<String> lista;
        Token tipo = new Token();
        jj_consume_token(12);
        lista = L_ID();
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
    final public void REGS() throws ParseException {
        ArrayList<String> lista;
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
    final public ArrayList<String> L_ID() throws ParseException {
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
    final public void RAIZ() throws ParseException {
...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
    ...
    final public Produccion PROD() throws ParseException {
        ArrayList<String> lista = new ArrayList<String>();
    ...
    final public ArrayList<Nodo> ACCIONES() throws ParseException {
        ArrayList<Nodo> acciones = new ArrayList<Nodo>();
        Nodo accion = null;
        jj_consume_token(24);
        label_5:
        while (true) {
    ...
    final public Nodo CALL_METODO() throws ParseException {
    ...
    final public Nodo CALL_WRITE() throws ParseException {
        Nodo exp;
        jj_consume_token(26);
        jj_consume_token(14);
        exp = EXPRESION();
    ...
    final public ArrayList<Nodo> PARAMS() throws ParseException {
    ...
    final public Nodo DESTINO() throws ParseException {
        Nodo nodo = null;
    ...
    final public ArrayList<Nodo> DIMENSIONES() throws ParseException {
        ArrayList<Nodo> dims = new ArrayList<Nodo>();
        Nodo nodo;
        jj_consume_token(28);
        nodo = EXP();
        jj_consume_token(29);
    ...
    final public Nodo LOG() throws ParseException {
        Nodo ret = null, or, orExtra;
        or = LOG_OR();
        label_8:
        while (true) {
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
    ...
    final public Nodo TER() throws ParseException {
        Nodo ret = null, factor, factorExtra;
        factor = FAC();
        label_12:
        while (true) {
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
    ...
    final public Nodo FAC() throws ParseException {
        Nodo ret = null, base, exp;
        base = INC();
        label_13:
        while (true) {
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
    ...
    final public Nodo INC() throws ParseException {
        Nodo ret = null, nodo;
        nodo = VAL();
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case 44:
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[]{0x83020, 0x83020, 0xf80, 0x40, 0xf80, 0x40, 0x30000, 0x30000, 0x8000, 0x400000, 0x1000000, 0x800000, 0x1000000, 0x1000000, 0x4000000, 0x4000000, 0x8000, 0x10004000, 0x10000000, 0x0, 0x10000000, 0x40000000, 0x80000000, 0x0, 0x10004000, 0x0, 0x0, 0x800000, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x8000000, 0x10004000, 0x0,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x100000, 0x100000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x140000, 0x0, 0x0, 0x1f74002, 0x0, 0x140000, 0x0, 0x0, 0x0, 0x1, 0x1f74002, 0xfc, 0xfc, 0x100, 0x100, 0x600, 0x600, 0x800, 0x3000, 0x3000, 0x0, 0x0, 0x4000, 0x1e70000,};
    }
