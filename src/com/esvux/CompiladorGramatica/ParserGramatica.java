...
//<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
  final public void REGLA() throws ParseException {Produccion obligatoria, extra;
  Token izq;
    //<ID> ".Regla" "=" PROD() ( "|" PROD() )*
...
extra.setLadoIzq(izq.image);
  ...
  final public Produccion PROD() throws ParseException {ArrayList<String> lista = new ArrayList<String>();
...
{if ("" != null) return Produccion.nuevaProduccion(lista, accionesDDS);}
    throw new Error("Missing return statement in function");
  }

  final public ArrayList<Nodo> ACCIONES() throws ParseException {ArrayList<Nodo> acciones = new ArrayList<Nodo>(); Nodo accion=null;
    jj_consume_token(24);
    label_5:
    while (true) {
      accion = ACCION();
...
{if ("" != null) return acciones;}
  ...
  final public Nodo ACCION() throws ParseException {Nodo nodo = null;
    try {
      if (jj_2_1(2)) {
        nodo = ASIGNACION();
        jj_consume_token(PYC);
...
if(ret==null) {if ("" != null) return base;} {if ("" != null) return ret;}
  ...
  final public Nodo INC() throws ParseException {Nodo ret = null, nodo;
    nodo = VAL();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 44:
    case 45:{
...
if(ret==null) {if ("" != null) return nodo;} {if ("" != null) return ret;}
  ...
  final public Nodo VAL() throws ParseException {Nodo nodo = null;
